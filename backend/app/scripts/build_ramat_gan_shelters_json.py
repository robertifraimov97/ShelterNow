...
INPUT_FILE = Path("data/ramat_gan_shelters.xlsx")
OUTPUT_FILE = Path("data/ramat_gan_official_shelters.json")
SHEET_NAME = "מקלטים רמת גן"
...
def main():
    ...
    for row in data_rows:
        ...
        geocoding_address = f"{address}, רמת גן, ישראל"
