...
INPUT_FILE = Path("data/herzliya_shelters.xlsx")
OUTPUT_FILE = Path("data/herzliya_official_shelters.json")
SHEET_NAME = "מקלטים הרצליה"
...
def main():
    ...
    for row in data_rows:
        ...
        geocoding_address = f"{address}, הרצליה, ישראל"
        ...
        shelter_record = {
            ...
            "source_name": "Herzliya Municipality",
            "source_url": None,
